...
function SignUp() {
  ...
  const [isMarketingModalOpen, setIsMarketingModalOpen] =
  ...
  //# 약관 동의 체크박스 아이콘 변경 시 실행 함수

  const handleCheckIconClick = (name: string, value: boolean) => {
    if (name === "개인정보") {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const requiredFields: (keyof UserSignUpInfo)[] = [
      "userId",
      "userPw",
      "checkPw",
      "userName",
    ...
    return (
      <Modal open={open} onClose={onClose} aria-labelledby="modal-title">
        <Box css={css.modalBoxStyle}>
          ...
          <Typography variant="body2" css={css.modalText}>
            {PRIVACY_POLICY_AGREED}
          </Typography>
          <Button onClick={onClose} variant="contained" css={css.modalCloseBtn}>
            닫기
          </Button>
        </Box>
      </Modal>
              ...
              <TextField
                ...
                slotProps={{
                  input: {
                    ...
                    style: {
                      borderBottom:
                        isSubmitted && errorsMsg?.userName
                          ? "2px solid #f44336"
                          : "",
                    },
                  },
                ...
                <TextField
                  ...
                  slotProps={{
                    input: {
                      ...
                      style: {
                        borderBottom:
                          isSubmitted && errorsMsg?.userEmail
                            ? "2px solid #f44336"
                            : "",
                      },
                    },
              ...
              <TextField
                ...
                slotProps={{
                  input: {
                    ...
                    style: {
                      borderBottom:
                        isSubmitted && errorsMsg?.userPhone
                          ? "2px solid #f44336"
                          : "",
                    },
                  },
                ...
                <TextField
                  ...
                  slotProps={{
                    input: {
                      ...
                      style: {
                        borderBottom:
                          isSubmitted && errorsMsg?.userBusinessNumber
                            ? "2px solid #f44336"
                            : "",
                      },
                    },
                      ...
                      <InputAdornment position="start">
                        {userSignUpInfo.privacyPolicyAgreed ? (
                          <CheckCircleOutlineIcon
                            onClick={() => handleCheckIconClick("개인정보", false)}
                            style={{ cursor: "pointer" }}
                          />
                        ) : (
                          <PanoramaFishEyeIcon
                            onClick={() => handleCheckIconClick("개인정보", true)}
                            style={{ cursor: "pointer" }}
                          />
                        )}
                      </InputAdornment>
              ...
              <TextField
                ...
                slotProps={{
                  input: {
                    startAdornment: (
                      <InputAdornment position="start">
                        {userSignUpInfo.marketingAgreed ? (
                          <CheckCircleOutlineIcon
                            onClick={() => handleCheckIconClick("마케팅", false)}
                            style={{ cursor: "pointer" }}
                          />
                        ) : (
                          <PanoramaFishEyeIcon
                            onClick={() => handleCheckIconClick("마케팅", true)}
                            style={{ cursor: "pointer" }}
                          />
                        )}
                      </InputAdornment>
